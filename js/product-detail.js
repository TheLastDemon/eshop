...
document.querySelector('#view-all-description').addEventListener('click', () => {
    ...
    document.querySelector('#view-all-description').innerHTML = content.classList.contains('active') ? 'скрыть' : 'показать'
})
                ...
                <div class="product-card">
                    ...
                    <div class="product-card-info">
                        <div class="product-btn">
                            <a href="./product-detail.html" class="btn-flat btn-hover btn-shop-now">купить</a>
